@extends('layouts.app')
@section('title', __('lang.title') . ' — Settings')
...
.flag-km { font-size: 1.05rem; }
.flag-en { font-size: 1.05rem; }
</style>
@endpush
...
<div class="row g-4 align-items-start">
    ...
    <div class="col-lg-10 col-md-9">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <div>
                <h5 class="mb-0 fw-bold"><i class="bi bi-translate me-2 text-primary"></i>{{ __('lang.title') }}</h5>
                <small class="text-muted">Edit the Khmer translations. English values are read-only references.</small>
            </div>
            <div class="d-flex gap-2">
                {{-- Live preview of active locale --}}
        ...
        <form action="{{ route('settings.translations.update') }}" method="POST">
            @csrf @method('PUT')
            ...
            <div class="card" style="overflow:hidden;">
                ...
                <div class="col-header">
                    <div>{{ __('lang.key') }}</div>
                    <div>🇬🇧 English</div>
                    <div>🇰🇭 ខ្មែរ (Khmer) — <em style="font-weight:400;text-transform:none;">editable</em></div>
                </div>
                ...
                <div class="group-header">
                    {{ $groupLabels[$prefix] ?? ucfirst($prefix) }}
                </div>
            ...
            <div style="position:sticky;bottom:0;background:#fff;border-top:1px solid #e2e8f0;
                ...
                <button type="submit" class="btn btn-primary px-4">
                    <i class="bi bi-check-lg me-1"></i>{{ __('lang.save') }}
                </button>
                <a href="{{ route('settings.translations.index') }}" class="btn btn-outline-secondary">
                    {{ __('common.cancel') }}
                </a>
            </div>
        </form>
