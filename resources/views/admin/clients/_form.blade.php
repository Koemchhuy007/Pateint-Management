...
<div class="mb-3">
    <label class="form-label fw-semibold">{{ __('admin.client_clinic_name') }} <span class="text-danger">*</span></label>
...
<div class="row g-3">
    ...
    <div class="col-md-6">
        <label class="form-label fw-semibold">{{ __('field.phone') }}</label>
...
<div class="mb-3 mt-3">
    <label class="form-label fw-semibold">{{ __('field.address') }}</label>
...
<div class="form-check form-switch mt-3">
    ...
    <label class="form-check-label" for="isActive">{{ __('admin.client_active_label') }}</label>
</div>
